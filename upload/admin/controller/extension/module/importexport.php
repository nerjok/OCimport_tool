...
class ControllerExtensionModuleImportexport extends Controller {
	...
	public function index() {
		$this->load->language('extension/module/importexport');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/importexport', 'user_token=' . $this->session->data['user_token'], true)
		);

		$data['action'] = $this->url->link('extension/module/importexport/uploadcsv', 'user_token=' . $this->session->data['user_token'], true);
		...
		$this->response->setOutput($this->load->view('extension/module/importexport', $data));
	}
	...
	public function uploadcsv(){
		$this->load->language('module/importexport');
				...
				$data['action'] = $this->url->link('extension/module/importexport/mapToCsv', 'user_token=' . $this->session->data['user_token'], true);
				...
				//$uploads_dir = DIR_IMAGE."image/temp";
		...
		/*foreach ($data['products'] as $key => $value) {
		  ...
		  fclose($handle);
			...
			$this->response->setOutput($this->load->view('extension/module/importexportlist', $data));
...
$this->response->redirect($this->url->link('extension/module/importexport', 'user_token=' . $this->session->data['user_token'], true));
	}
...
$store_id=0;
	...
	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/module/importexport')) {
